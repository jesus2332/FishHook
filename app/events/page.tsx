...
const eventCardAnimation = "transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-2"
const floatingBackground = "bg-gradient-to-r from-muted via-muted/50 to-muted bg-[length:200%_100%]"
...
export default function EventsPage() {
  ...
  return (
    <div className="flex flex-col">
      <section className={`${floatingBackground} py-16 md:py-24`} style={{ animation: "floatingBg 15s ease infinite" }}>
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Próximos eventos</h1>
      ...
      <section className="py-16">
        <div className="container">
          <h2 className="mb-8 text-2xl font-bold">Eventos</h2>
              ...
              <div key={month}>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {groupedEvents[month].map((event) => (
                    <Card key={event.id} className={`overflow-hidden ${eventCardAnimation}`}>
                      <div
                      ...
                      <CardContent className="p-4" onClick={() => setSelectedEvent(event)}>
                        <h4
                          className="mb-2 text-lg font-bold cursor-pointer hover:text-primary transition-colors"
                        >
                          {event.title}
                        </h4>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-in fade-in duration-300">
              <div className="max-h-[90vh] w-full max-w-3xl overflow-auto rounded-lg bg-background p-6 animate-in slide-in-from-bottom-10 duration-500">
                <div className="mb-6 flex items-start justify-between">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => setSelectedEvent(null)} aria-label="Cerrar detalles">
                    <X className="h-5 w-5" />
                  </Button>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div
                    ...
                    onClick={() => openLightbox(selectedEvent.image, selectedEvent.title)}
                  >
                    <Image
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <Calendar className="mr-2 h-4 w-4 text-primary" />
                        <span>
                          {new Date(`${selectedEvent.date}T12:00:00`).toLocaleDateString("es-ES", {
                            weekday: "long",
                            month: "long",
                            day: "numeric",
                            year: "numeric",
